...
const mockOrder = {
    ...
    payment_method: 'cod',
    payment_status: 'paid',
    billing_details: { firstName: 'Mohamad', lastName: 'Jamal', streetAddress: 'Deira, Dubai', city: 'Dubai', phone: '+971509955446' },
    shipping_address: { firstName: 'Mohamad', lastName: 'Jamal', streetAddress: 'Deira, Dubai', city: 'Dubai', phone: '+971509955446' },
    items: [
        { name: 'Star Max 6036CBF, Countertop Gas Lava Rock Charbroiler 36"', quantity: 2, price_at_purchase: 6990.0, image: 'https://mariotstore.com/wp-content/uploads/2024/10/charbroiler.png' },
        { name: 'Ooni Koda 16 Gas Outdoor Pizza Oven', quantity: 1, price_at_purchase: 4029.0, is_free_gift: 1, bundle_parent_name: 'Star Max Charbroiler', image: 'https://mariotstore.com/wp-content/uploads/2024/10/kitchen-equipment-store.png' }
    ]
};

const mockCart = [
    { name: 'Ooni Koda 16 Gas Outdoor Pizza Oven', quantity: 1, price: 4029.0, offer_price: 3876.06, image: 'https://mariotstore.com/wp-content/uploads/2024/10/charbroiler.png', slug: 'ooni-koda-16-gas' },
    { name: 'Fama Industrie FA253, Food Slicer', quantity: 1, price: 6325.0, offer_price: null, image: 'https://mariotstore.com/wp-content/uploads/2024/10/kitchen-equipment-store.png', slug: 'fama-fa253-food-slicer' }
];
...
const mockOfferProduct = {
    ...
    price: 4029.0,
    offer_price: 3399.0,
    primaryImage: 'https://mariotstore.com/wp-content/uploads/2024/10/charbroiler.png'
};
...
async function run() {
    ...
    const steps = [
        ...
        ['Order Status — Delivered', () => sendOrderStatusUpdateEmail(to, NAME, mockOrder.id, 'delivered', { ...mockOrder, subject: `Your order #${mockOrder.id} delivered — Mariot (${t()})` })],
